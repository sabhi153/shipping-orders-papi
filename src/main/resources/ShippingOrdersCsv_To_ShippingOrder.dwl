...
---
(vars.csvReaderParserMap.parser as Iterator map((csvRecord, index) -> translateCSVRecord(csvRecord,vars.csvFormat) )) filter !(capitalize($.shipmentNumber) contains capitalize("Shipment"))